        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 gap-y-16 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 font-medium text-sm">
              ...
              <li><a href="tel:+1234567890" className="text-gray-400 hover:text-brand-400 transition-colors">+91 Nihal Pandey</a></li>
              ...
              <li><a href="tel:+1234567890" className="text-gray-400 hover:text-brand-400 transition-colors">+91 7717794185</a></li>
            </ul>
          </div>
        </div>
